...
file_1 = np.loadtxt("../perturbations_k_1.txt")
...
x                                                                   = file_01[:,0]
Theta_0_k01,   Theta_0_k001,   Theta_0_k0001,   Theta_0_k1          = file_01[:,1],    file_001[:,1],     file_0001[:,1],   file_1[:,1]
Theta_1_k01,   Theta_1_k001,   Theta_1_k0001,   Theta_1_k1          = file_01[:,2],    file_001[:,2],     file_0001[:,2],   file_1[:,2]
Theta_2_k01,   Theta_2_k001,   Theta_2_k0001,   Theta_2_k1          = file_01[:,3],    file_001[:,3],     file_0001[:,3],   file_1[:,3]
Phi_k01,       Phi_k001,       Phi_k0001,       Phi_k1              = file_01[:,4],    file_001[:,4],     file_0001[:,4],   file_1[:,4]
Psi_k01,       Psi_k001,       Psi_k0001,       Psi_k1              = file_01[:,5],    file_001[:,5],     file_0001[:,5],   file_1[:,5]
delta_cdm_k01, delta_cdm_k001, delta_cdm_k0001, delta_cdm_k1        = file_01[:,6],    file_001[:,6],     file_0001[:,6],   file_1[:,6]
v_cdm_k01,     v_cdm_k001,     v_cdm_k0001,     v_cdm_k1            = file_01[:,7],    file_001[:,7],     file_0001[:,7],   file_1[:,7]
delta_b_k01,   delta_b_k001,   delta_b_k0001,   delta_b_k1          = file_01[:,8],    file_001[:,8],     file_0001[:,8],   file_1[:,8]
v_b_k01,       v_b_k001,       v_b_k0001,       v_b_k1              = file_01[:,9],    file_001[:,9],     file_0001[:,9],   file_1[:,9]
eta_k01,       eta_k001,       eta_k0001,       eta_k1              = file_01[:,10],   file_001[:,10],    file_0001[:,10],  file_1[:,10]

fig, ax = plt.subplots(2, sharex=True)
ax[0].set_title(r"$\delta_{CDM}, \delta_b$")
ax[1].set_title(r"$\delta_\gamma$")
ax[0].plot(x, delta_cdm_k1, label=r"k = 1", color="purple")
...
ax[0].plot(x, v_cdm_k01, label=r"k = 1", color="purple")
...
ax.plot(x, Theta_0_k1, label=r"k = 1", color="purple")
...
ax.plot(x, Theta_1_k1, label=r"k = 1", color="purple")
...
ax.plot(x, Theta_2_k1, label=r"k = 1", color="purple")
...
fig, ax = plt.subplots()
ax.set_title(r"$\Phi$")
ax.plot(x, Phi_k1, label=r"k = 1", color="purple")
...
ax.plot(x, Phi_k1+Psi_k1, label=r"k = 1", color="purple")
